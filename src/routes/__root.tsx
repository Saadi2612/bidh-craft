  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="surface-card max-w-md p-10 text-center">
        ...
        <h1 className="mt-4 text-2xl">This box seems to be empty</h1>
  ...
  head: () => ({
    meta: [
      ...
      { title: "THEBIDHCRAFT — Handcrafted Boxes for Every Happy Moment" },
      {
        name: "description",
        content:
          "Handmade, hand-printed gift and favor boxes for Nikkah, Walima, Mehndi, Aqeeqa and birthdays. Order on WhatsApp.",
      },
      { name: "author", content: "THEBIDHCRAFT" },
      { property: "og:site_name", content: "THEBIDHCRAFT" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#F8C7CC" },
    ],
    links: [
